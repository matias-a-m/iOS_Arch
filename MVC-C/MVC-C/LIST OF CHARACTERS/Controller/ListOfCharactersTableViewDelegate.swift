...
class ListOfCharactersTableViewDelegate: NSObject, UITableViewDelegate {
    ...
    /// Clousure que se llama cuando se toca una celda en la tabla. El parámetro representa  el índice de la celda seleccionada
    var didTapOnCell: ((Int) -> Void)?
    
    //MARK: - UITableViewDelegate Methods
    
    /// Método llamado cuando se toca una celda de la tabla.
    /// - Parameters:
    ...
    ///     - tableView: La tabla que contiene la celda.
    ///     - indexPath: La ubicación de la celda seleccionada.
    ///  - Returns: La altura deseada para la celda en la posicón especificada.
